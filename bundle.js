...
var TaskList = /*#__PURE__*/function () {
  ...
  _createClass(TaskList, [{
    ...
    value: function addNewScrap() {
      var title = this.titleInput.nodeValue;
      var message = this.messageInput.nodeValue;
